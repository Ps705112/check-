...
from database.instareddb import add_inst_filter, remove_inst, get_ids, get
from database.users_chats_db import db
from info import CHANNELS, ADMINS, AUTH_CHANNEL, LOG_CHANNEL, PICS, BATCH_FILE_CAPTION, CUSTOM_FILE_CAPTION
from utils import get_size, is_subscribed, temp, search_gagala, get_name, get_name2
import re
import json
import base64
        ...
        btn = [
            [
                InlineKeyboardButton(
                    "🤖 Join Official Channel & Try Press Again", url=invite_link.invite_link
                )
            ]
        ]
